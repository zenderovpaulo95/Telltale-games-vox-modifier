...
```
git clone https://gitflic.ru/project/pashok6798/telltale-games-vox-modifier.git
cd telltale-games-vox-modifier
...
cd existing_folder
git init
git remote add origin https://gitflic.ru/project/pashok6798/telltale-games-vox-modifier.git
git clone
